  ...
  return (
    ...
    <>
      ...
      <Route exact path="/" element={<LandingPage></LandingPage>} />
          ...
          <Route exact path='/candidateLogin' element={<CandidateLogin></CandidateLogin>}/>
          <Route exact path='/recruiterLogin' element={<RecruiterLogin></RecruiterLogin>}/>
          <Route path="/candidateRegister" element={<Register />} />
          <Route path="/dashboard" element={<Dashboard />} />
          <Route path='/recruiterDashboard' element={<RecruiterDashboard></RecruiterDashboard>}></Route>
          <Route path='/applications' element = {<ApplicationSwipe></ApplicationSwipe>}></Route>
          <Route path='/shortlisted' element ={<ShortListed></ShortListed>}></Route>
        </Routes>
