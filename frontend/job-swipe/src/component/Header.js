      ...
      <div className="w-[100%] flex justify-center items-center h-[20%] pt-4">
        <div className="shadow-2xl w-[50%] bg-[#131320] h-full p-2 cursor-pointer rounded-3xl " >
          <div className="grid grid-cols-3 gap-4">
            {/* Jobs */}
            <div className="flex flex-col justify-center items-center" onClick={() => setSelectedPage("job")}>
              <div
                className={`transition-all duration-300 transform ${
                  selectedPage === "job"
                    ? "bg-sky-500 flex justify-center items-center w-16 h-16 rounded-full scale-125"
                    : "flex justify-center items-center w-12 h-12 rounded-full scale-100"
                }`}
              >
                <svg
                  xmlns="http://www.w3.org/2000/svg"
                  width={selectedPage === "job" ? "28" : "20"}
                  height={selectedPage === "job" ? "28" : "20"}
                  fill="white"
              ...
              <span className={`text-xs mt-1 transition-all duration-300 ${
                selectedPage === "job" ? "opacity-0 h-0" : "opacity-100 h-auto"
              } text-white`}>
                Jobs
              </span>
            </div>
            ...
            {/* Home */}
            <div className="flex flex-col justify-center items-center" onClick={() => setSelectedPage("home")}>
              <div
                className={`transition-all duration-300 transform ${
                  selectedPage === "home"
                    ? "bg-sky-500 flex justify-center items-center w-16 h-16 rounded-full scale-125"
              ...
              >
                <svg
                  xmlns="http://www.w3.org/2000/svg"
                  width={selectedPage === "home" ? "28" : "20"}
                  height={selectedPage === "home" ? "28" : "20"}
                  fill="white"
              ...
              <span className={`text-xs mt-1 transition-all duration-300 ${
                selectedPage === "home" ? "opacity-0 h-0" : "opacity-100 h-auto"
              } text-white`}>
                Home
              </span>
            </div>
            ...
            {/* Profile */}
            <div className="flex flex-col justify-center items-center" onClick={() => setSelectedPage("profile")}>
              <div
                className={`transition-all duration-300 transform ${
              ...
              >
                <svg
                  xmlns="http://www.w3.org/2000/svg"
                  width={selectedPage === "profile" ? "28" : "20"}
                  height={selectedPage === "profile" ? "28" : "20"}
                  fill="white"
              ...
              <span className={`text-xs mt-1 transition-all duration-300 ${
                selectedPage === "profile" ? "opacity-0 h-0" : "opacity-100 h-auto"
              } text-white`}>
                Profile
              </span>
            </div>
...
//         {/* <div className="shadow-2xl w-[50%] bg-[#] h-full p-2 cursor-pointer rounded-3xl " > */}
//          <div className="shadow-2xl w-[50%] bg-[#191929] h-full p-2 cursor-pointer rounded-3xl " >
//           <div className="grid grid-cols-3 gap-4">
//             {/* jobs */}
